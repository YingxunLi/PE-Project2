...
<head>
    ...
    <title>3D Pyramid Snake Visualization</title>
    ...
    <script>
        ...
        function setup() {
            ...
            for (let i = 0; i < segments; i++) {
                pyramids.push({ 
                    baseCenter: createVector(-i * segmentLength, 0, 0), 
                    apex: createVector(0, 0, 80) 
                });
            }
        }
        ...
        function draw() {
            ...
            for (let i = 1; i < pyramids.length; i++) {
                ...
                current.baseCenter.set(
                    prev.baseCenter.x - direction.x, 
                    prev.baseCenter.y - direction.y, 
                    prev.baseCenter.z - direction.z
                );
